...
=======
    ...
    CentralBank.EventsMan.append(Event(1, 3600, 0.56, 0.78, 'Вы можете инвесттировать 3600 рублей в больницы Y/N', 'Y', 'инвеситиции приняты', 'инвестиции не приняты', 'Вы повысили доверие людей к банковской системе на ','Реакции не последовало'))
    CentralBank.EventsMan.append(Event(1, 7800, 0.34, 0.67, 'Вы можите инвестировать 7800 рублей в продукт "Coca-cola" Y/N', 'Y', 'инвеситиции приняты', 'инвестиции не приняты','Вы повысили доверие людей к банковской системе на ', 'Реакции не последовало'))
    CentralBank.EventsMan.append(Event(1, 5688, 0.45, 0.98, 'Вы можите инвестировать 5688 рублей в "газпром" Y/N', 'Y', 'инвиситиции приняты','инвестиции неприняты', 'Вы повысили доверие людей к банковской системе на ', 'Реакции не последовало'))
    CentralBank.EventsMan.append(Event(1, 6778, 0.02, 0.19, 'Вы можете купить акции за 6778 Y/N', 'Y', 'вы купили акции', 'акции не куплены','вы купили акции и повысили надежность системы на ', 'Реакции на покупку не последовало'))
    CentralBank.EventsMan.append(Event(1, -3000, -0.76, -0.12, 'Вы можете продать свои ценные бумаги за 3000 Y/N', 'Y', 'бумаги проданы', 'бумаги не проданы','Вы продали свои бумаги понизив надежностьь банковской системы на', 'реакции не последовало'))
    CentralBank.EventsMan.append(Event(1, -6789, -0.23, -0.06, 'Вы можете продать свои ценные бумаги за 6789 Y/N', 'Y', 'бумаги проданы', 'бумаги не проданы', 'Вы продали свои бумаги понизив надежностьь банковской системы на', 'реакции не последовало'))
    CentralBank.EventsMan.append(Event(1, -4069, -0.78, -0.38, 'У вас есть возможность продать свои акции за 4060 Y/N', 'Y', ' акции проданы','акции не проданы', 'Вы понизили доверие к банковской системе на ', 'Реакции не последовало'))
    ...
    CentralBank.EventsUnman.append(Event(1, 5000, 0.04, 0.09,"5000 рублей были выданны правительством для поддержания бюджетной политики",'', '', '', 'Глобальная встревоженность понижена на', ""))
    CentralBank.EventsUnman.append(Event(1, 2000, 0.13, 0.02,"Две тысячи рублей были востребованны правительством для поддержания бюджетной политики ",'', '', '', 'Глобальная встревоженность повышенна на', ""))
