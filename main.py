...
def initWorld():
    ...
    CentralBank.EventsMan.append(Event(1, -55000, -0.6, -0.4, 'У вас есть возможность продать свои акции за 55000 Y/N ', 'Y', ' акции проданы','акции не проданы', 'Вы понизили доверие к банковской системе на ', 'Реакции не последовало'))
    CentralBank.EventsMan.append(Event(1, 54356, 0.04, 0.05, 'Вы можете купить акции за 54356 Y/N ', 'Y', 'вы купили акции', 'акции не куплены','вы купили акции и повысили надежность системы на ', 'Реакции на покупку не последовало'))
    CentralBank.EventsMan.append(Event(1, 23600, 0.56, 0.78, 'Вы можете инвесттировать 23600 рублей в больницы Y/N ', 'Y', 'инвеситиции приняты', 'инвестиции не приняты', 'Вы повысили доверие людей к банковской системе на ','Реакции не последовало'))
    CentralBank.EventsMan.append(Event(1, 17800, 0.34, 0.67, 'Вы можите инвестировать 17800 рублей в продукт "Coca-cola" Y/N ', 'Y', 'инвеситиции приняты', 'инвестиции не приняты','Вы повысили доверие людей к банковской системе на ', 'Реакции не последовало'))
    CentralBank.EventsMan.append(Event(1, 45688, 0.45, 0.98, 'Вы можите инвестировать 45688 рублей в "газпром" Y/N ', 'Y', 'инвиситиции приняты','инвестиции неприняты', 'Вы повысили доверие людей к банковской системе на ', 'Реакции не последовало'))
    CentralBank.EventsMan.append(Event(1, 26778, 0.02, 0.19, 'Вы можете купить акции за 26778 Y/N ', 'Y', 'вы купили акции', 'акции не куплены','вы купили акции и повысили надежность системы на ', 'Реакции на покупку не последовало'))
    CentralBank.EventsMan.append(Event(1, -73000, -0.76, -0.12, 'Вы можете продать свои ценные бумаги за 73000 Y/N ', 'Y', 'бумаги проданы', 'бумаги не проданы','Вы продали свои бумаги понизив надежностьь банковской системы на', 'реакции не последовало'))
    CentralBank.EventsMan.append(Event(1, -56789, -0.23, -0.06, 'Вы можете продать свои ценные бумаги за 56789 Y/N ', 'Y', 'бумаги проданы', 'бумаги не проданы', 'Вы продали свои бумаги понизив надежностьь банковской системы на', 'реакции не последовало'))
    CentralBank.EventsMan.append(Event(1, -44069, -0.78, -0.38, 'У вас есть возможность продать свои акции за 44060 Y/N ', 'Y', ' акции проданы','акции не проданы', 'Вы понизили доверие к банковской системе на ', 'Реакции не последовало'))
    CentralBank.EventsUnman.append(Event(1, 0, 0.05, 0.08, "Известный бизнесмен вложился и выкупил долговые обязательства банков-должников", '', '','', 'Глобальная встревоженность понижена на',""))
    CentralBank.EventsUnman.append(Event(1, 10000, 0.05, 0.08,"Десять тысяч рублей были востребованны правительством для поддержания бюджетной политики ",'', '', '', 'Глобальная встревоженность повышенна на',""))
    CentralBank.EventsUnman.append(Event(1, 35000, 0.04, 0.09,"35000 рублей были выданны правительством для поддержания бюджетной политики",'', '', '', 'Глобальная встревоженность понижена на', ""))
    CentralBank.EventsUnman.append(Event(1, 22000, 0.13, 0.02,"Двадцать две тысячи рублей были востребованны правительством для поддержания бюджетной политики ",'', '', '', 'Глобальная встревоженность повышенна на', ""))
    CentralBank.EventsUnman.append(Event(1, 0, 0.1, 0.1,
                                         "",
                                         '', '', '', 'Глобальная встревоженность понижена на', ""))
    CentralBank.EventsUnman.append(Event(1, 3056, 0.14, 0.19,"Приобретение банком государственных ценных бумаг на сумму 3056 рублей",'', '', '', 'Глобальная встревоженность понижена на', ""))
    CentralBank.EventsUnman.append(Event(1, 6455, 0.09, 0.17,"Покупка национальной валюты за 6455 рублей",'', '', '', 'Глобальная встревоженность понижена на', ""))
    CentralBank.EventsUnman.append(Event(1, 0, 0.1, 0.1,
                                         "(что то связанное со ставкой процента)",
                                         '', '', '', 'Глобальная встревоженность понижена на', ""))
    CentralBank.EventsUnman.append(Event(1, 7000, 0.03, 0.06,"Выкуп отдельных облигаций федеральных займов на 7000 рублей",'', '', '', 'Глобальная встревоженность понижена на', ""))
    CentralBank.EventsUnman.append(Event(1, 8000, 0.02, 0.13,"Погашение задолженности по средствам в иностранной валюте размере 8000 рублей",'', '', '', 'Глобальная встревоженность понижена на', ""))
    CentralBank.EventsUnman.append(Event(1, 8046, 0.04, 0.01,"8046 рублей были выданны правительством для поддержания бюджетной политики",'', '', '', 'Глобальная встревоженность понижена на', ""))
