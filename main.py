...
def initWorld():
    ...
    CentralBank.EventsUnman.append(Event(1, 100000, 0.05, 0.08,
                                         "100 000 рублей были востребованны правительством для поддержания бюджетной политики ",
                                         '', '', '',
                                         'Глобальная встревоженность  в результате проведения политики понижена на',
                                         ""))
